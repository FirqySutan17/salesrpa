...
<div class="main-content pre-posttest">
    <h3 class="card-title">
        <strong>DETAIL REQUEST ORDER</strong>
    </h3>
        ...
        <form class="form-category" action="<?= admin_url('confirm/do_create') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="table-responsive mt-2">
                    <table class="table table-bordered" style="margin-bottom: 0px">
                        ...
                        <tbody>
                            <tr>
                                <td data-label="DATE">
                                    <?= date('d-m-Y', strtotime($detail['REQUEST_ORDER']['REQ_DATE'])) ?>
                                </td>
                                <td data-label="REQUEST NO">
                                    #<?= $detail['REQUEST_ORDER']['REQ_NO'] ?>
                                </td> 
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered" style="margin-bottom: 0px">
                        <thead>
                            <tr>
                                <th style="text-align: left" width="50%">AREA</th>
                        ...
                        <tbody>
                            <tr>
                                <td data-label="AREA">
                                    <?= $detail['REQUEST_ORDER']['AREA_NAME'] ?>
                                </td>
                                <td data-label="CUSTOMER">
                                    <?= $detail['REQUEST_ORDER']['CUSTOMER'] ?> - <?= $detail['REQUEST_ORDER']['FULL_NAME'] ?>
                                </td> 
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td data-label="PROJECT">
                                    <?= $detail['REQUEST_ORDER']['PROJECT'] ?>
                                </td>
                                <td data-label="PLAZMA">
                                    <?= $detail['REQUEST_ORDER']['PLAZMA'] ?> - <?= $detail['REQUEST_ORDER']['PLAZMA_NAME'] ?>
                                </td>
                                <td data-label="FARM">
                                    <?= $detail['REQUEST_ORDER']['FARM'] ?> - <?= $detail['REQUEST_ORDER']['FARM_NAME'] ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered" style="margin-bottom: 0px">
                        ...
                        <tbody>
                            <tr>
                                <td data-label="QTY">
                                    <?= number_format($detail['REQUEST_ORDER']['QTY']) ?>
                                </td>
                                <td data-label="WEIGHT (KG)">
                                    <?= number_format($detail['REQUEST_ORDER']['BW']) ?>
                                </td> 
                                <td data-label="PRICE">
                                <?= number_format($detail['REQUEST_ORDER']['UP']) ?>
                                </td>
                                <td data-label="AMOUNT">
                                    <?= number_format($detail['REQUEST_ORDER']['AMOUNT']) ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td data-label="CONTROL NO">
                                    <?= $detail['REQUEST_ORDER']['CONTROL_NO'] ?>
                                </td>
                                <td data-label="REMARKS">
                                    <?= $detail['REQUEST_ORDER']['REMARKS'] ?>
                                </td> 
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered" style="margin-bottom: 0px">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: left" width="50%">FILE</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td data-label="PHONE NUMBER">
                                <?= $detail['REQUEST_ORDER']['CUST_PHONE_NO'] ?>
                                </td>
                                <td data-label="FILE">
                                    <img style="width: 100%; object-fit: cover" src="<?= base_url('upload/'.$detail['REQUEST_ORDER']['IMAGE']) ?>" alt="">
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="form-group row mt-5" style="margin: 20px 0px !important">
                <div class="col-lg-12 col-sm-12" style="display: flex; padding: 0px">
                    <?php if ($detail['REQUEST_ORDER']['CONFIRM_STATUS'] == 'Y'): ?>
                        <a href="<?= route('dashboard/confirm/pdf') ?>" class="btn btn-primary cust-btn-back" style="width: 100%; height: 50px; display: flex; align-items: center; justify-content: center;">PDF</a>
                    <?php endif ?>
