...
<div class="main-content pre-posttest">
    ...
    <div class="row" style="padding: 0px 10px; border-bottom: 2px solid #000; padding-bottom: 8px;margin: 0px 0px; margin-bottom: 10px; ">
        <div class="col-12">
        <form id="form-headcode" action="<?= admin_url('setting-approval') ?>" method="POST"><input type="hidden" name="role" id="input-headcode"></form>
        </div>
    </div>
    <div class="wrap-cc">
        <div class="cc-item">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr data-role="<?= $v ?>" class="headcode_data <?= $v == $active_role ? 'active-row' : '' ?>">
                        <td><?= $v ?></td>
                    </tr>
                    <?php endforeach ?>
                </tbody>
                    ...
                    <?php foreach ($datatable as $i => $v): ?>
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle">
                                <a href="<?= admin_url('setting-approval/edit/'.$v['EMPLOYEE_ID']) ?>" class="btn btn-sm"><i class="fas fa-pen text-warning"></i></a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
