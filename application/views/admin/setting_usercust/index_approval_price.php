...
<div class="main-content pre-posttest">
    <h3 class="card-title">
        <strong>SETTING - SALES APPROVAL PRICE</strong>
    </h3>
    ...
    <div class="wrap-cc">
        <div class="cc-item">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <tr data-headcode="APR01" class="headcode_data active-row">
                        <td>APR01</td>
                ...
                <tbody>
                    <?php foreach ($datatable as $i => $v): ?>
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle"><?= formatRupiah($v['DESC1']) ?></td>
                            <td style="text-align: center; vertical-align: middle"><?= formatRupiah($v['DESC2']) ?></td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
            </table>
