...
<div class="main-content pre-posttest">
    <h3 class="card-title">
        <strong>SETTING - USER to CUSTOMER</strong>
    </h3>
            ...
            <?php foreach ($datatable as $i => $v): ?>
                <tr>
                    ...
                    <td style="text-align: center; vertical-align: middle">
                        <a href="<?= admin_url('setting-user-customer/area/'.$v['EMPLOYEE_ID']) ?>" class="btn btn-primary btn-sm">MAPPING AREA</a>
                    </td>
                    <td style="text-align: center; vertical-align: middle">
                        <a href="<?= admin_url('setting-user-customer/edit/'.$v['EMPLOYEE_ID']) ?>" class="btn btn-info btn-sm">MAPPING CUSTOMER</a>
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>
