            ...
            <div class="form-group row mt-5" style="margin: 20px 0px !important">
                <div class="col-lg-12 col-sm-12" style="display: flex; padding: 0px">
                    <?php if ($detail['REQUEST_ORDER']['CONFIRM_STATUS'] == 'Y'): ?>
                        <a href="<?= route('dashboard/order/pdf') ?>" class="btn btn-primary cust-btn-back" style="width: 100%; height: 50px; display: flex; align-items: center; justify-content: center;">PDF</a>
                    <?php endif ?>
