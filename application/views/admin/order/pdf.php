...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <h2 style="margin:100px 0px 0px 0px;">DELIVERY ORDER</h2>
        ...
        <div class="content">
            <table>
                <tr>
                    ...
                    <td style="border: none; padding: 5px 10px">Team</td>
                    <td style="border: none; padding: 5px 10px">: <?= $detail['REQUEST_ORDER']['TEAM_NAME'] ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="border: none; padding: 5px 10px">: <?= $detail['ORDER']['FARM_NAME'].' - '.$detail['REQUEST_ORDER']['TEAM_NAME'] ?></td>
                </tr>
                <tr>
